...
BLOG_AUTHOR = "tj2"  # (translatable)
BLOG_TITLE = u"绿萝间"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://muxuezi.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://muxuezi.github.io/"
BLOG_EMAIL = "muxuezi@gmail.com"
BLOG_DESCRIPTION = "Tao Junjie blog"  # (translatable)
...
NAVIGATION_LINKS = {
        DEFAULT_LANG: (
                    ...
                    ('https://twitter.com/muxuezi', 'My Twitter', 'icon-twitter'),
                    ('https://github.com/muxuezi', 'My Github', 'icon-github'),
                )
}
...
PAGES = (
    ("posts/*.ipynb", "posts", "story.tmpl"),
    ("posts/*.md", "posts", "story.tmpl"),
...
COMPILERS = {
    "markdown": ('.txt', '.md', '.wp', '.mdown', '.markdown'),
    "textile": ('.textile',),
    "txt2tags": ('.t2t',),
    "bbcode": ('.bb',),
    "wiki": ('.wiki',),
...
OUTPUT_FOLDER = '../muxuezi.github.io'
...
# Do you want a add a Mathjax config file?THJAX_CONFIG = """
MATHJAX_CONFIG = """
